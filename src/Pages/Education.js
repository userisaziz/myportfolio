                ...
                <div className="educationblock">
                  <div className="row">
                    <div className="col-sm-4">
                      <h5 data-aos="fade-right">Jan, 2022 - April, 2022</h5>
                    </div>
                    <div className="col-sm-8">
                      <div className="educationright" data-aos="fade-left">
                        <h5>STRUCTWEL DESIGNERS & CONSULTANTS PVT LTD</h5>
                        <h6>Project - "IOCL COST EST TFMS AND BLENDING SYSTEM LBP TALOJA"</h6>
                        <h6>
                          - AUTOCAD 2D/3D.
                          <br />
                          - Adobe Photoshop
